          ...
          <div class="bg-white border border-[#D3D1C7] rounded-xl p-5">
            ...
            >
              <div class="space-y-3 mb-4">
                <div>
                  <label for="class-name" class="block text-[10.5px] font-semibold uppercase tracking-wide text-[#888780] mb-1.5">Class name</label>
                  <input
                    id="class-name"
                    name="name"
                    type="text"
                ...
                <div>
                  <label for="class-description" class="block text-[10.5px] font-semibold uppercase tracking-wide text-[#888780] mb-1.5">Description <span class="normal-case font-normal text-[#B4B2A9]">(optional)</span></label>
                  <input
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="space-y-4 mb-5">
          <div>
            <label for="edit-announcement-title" class="block text-[11px] font-semibold uppercase tracking-wide text-[#5F5E5A] mb-1.5">Title</label>
            <input
          ...
          <div>
            <label for="edit-announcement-content" class="block text-[11px] font-semibold uppercase tracking-wide text-[#5F5E5A] mb-1.5">Message</label>
            <textarea
